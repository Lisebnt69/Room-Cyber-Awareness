    ...
    <div className="analytics-page">
      <div className="analytics-shell">
        <nav className="analytics-nav">
          <img src={Logo} alt="ROOMCA" className="analytics-logo" />
          <div className="analytics-nav-actions">
            <LangToggle />
            <button onClick={() => navigate('/admin')} className="analytics-link-btn">
              ← Dashboard
            </button>
            <button onClick={handleLogout} className="btn-secondary analytics-logout-btn">
              Logout
            </button>
          </div>
        </nav>
        ...
        <div className="analytics-container">
          <div className="analytics-header">
            ...
            <div className="analytics-header-actions">
              ...
              <button onClick={handleExportPDF} className="btn-primary analytics-export-btn">
                📥 Export PDF
              </button>
            </div>
          </div>
          ...
          <div className="analytics-card analytics-trends-card">
            <h3>📈 Weekly Trends</h3>
