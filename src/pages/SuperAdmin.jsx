...
const INITIAL_SCENARIOS = [
  ...
  { id: 8, title: { fr: 'Vishing support IT', en: 'IT Support Vishing' }, category: 'Social Eng.', difficulty: 'intermediate', duration: '8', plays: 0, score: 0, status: 'draft', description: 'Faux appel support demandant un code MFA', modules: ['photo', 'mapping', 'quiz'], photoHotspots: [{ id: 8001, x: 41, y: 55, label: 'Numéro inconnu' }, { id: 8002, x: 66, y: 34, label: 'Ton urgent' }, { id: 8003, x: 23, y: 72, label: 'Demande MFA' }], quizQuestions: [{ id: 801, prompt: 'Quel canal de vérification utiliser ?' }, { id: 802, prompt: 'Peut-on partager un code MFA ?' }, { id: 803, prompt: 'Quel signal est critique ?' }] },
  { id: 9, title: { fr: 'Clé USB “salaire 2026”', en: 'USB Bait Salary 2026' }, category: 'Malware', difficulty: 'advanced', duration: '10', plays: 0, score: 0, status: 'draft', description: 'Support amovible trouvé dans les locaux', modules: ['photo', 'mapping', 'quiz'], photoHotspots: [{ id: 9001, x: 52, y: 63, label: 'Média inconnu' }, { id: 9002, x: 31, y: 45, label: 'Nom attractif' }, { id: 9003, x: 72, y: 58, label: 'Origine inconnue' }], quizQuestions: [{ id: 901, prompt: 'Quelle procédure appliquer ?' }, { id: 902, prompt: 'Quel risque principal ?' }, { id: 903, prompt: 'Qui doit analyser la clé ?' }] },
  { id: 10, title: { fr: 'QR Code parking gratuit', en: 'Free Parking QR Trap' }, category: 'Phishing', difficulty: 'beginner', duration: '7', plays: 0, score: 0, status: 'draft', description: 'Quishing via affiche et QR code', modules: ['photo', 'fakeLink', 'fakeEmail', 'quiz'], photoHotspots: [{ id: 10001, x: 47, y: 49, label: 'QR non officiel' }, { id: 10002, x: 61, y: 64, label: 'Promesse trop belle' }, { id: 10003, x: 29, y: 40, label: 'Aucune marque' }], quizQuestions: [{ id: 1001, prompt: 'Quel est le risque du quishing ?' }, { id: 1002, prompt: 'Que vérifier avant login ?' }, { id: 1003, prompt: 'Comment signaler ?' }] },
  { id: 11, title: { fr: 'Invitation Teams externe', en: 'External Teams Invite' }, category: 'Credentials', difficulty: 'intermediate', duration: '9', plays: 0, score: 0, status: 'draft', description: 'Fausse invitation réunion avec login SSO', modules: ['fakeLink', 'fakeEmail', 'quiz'], photoHotspots: [{ id: 11001, x: 63, y: 58, label: 'Fausse page login' }, { id: 11002, x: 36, y: 44, label: 'Expéditeur externe' }, { id: 11003, x: 72, y: 31, label: 'Urgence anormale' }], quizQuestions: [{ id: 1101, prompt: 'Quel outil utiliser ?' }, { id: 1102, prompt: 'Pourquoi éviter le lien direct ?' }, { id: 1103, prompt: 'Quel indice trahit la fraude ?' }] },
  { id: 12, title: { fr: 'Fraude au président', en: 'CEO Fraud Transfer' }, category: 'Social Eng.', difficulty: 'advanced', duration: '13', plays: 0, score: 0, status: 'draft', description: 'Demande urgente de virement hors process', modules: ['fakeEmail', 'quiz'], photoHotspots: [{ id: 12001, x: 39, y: 47, label: 'Ton inhabituel' }, { id: 12002, x: 71, y: 60, label: 'Hors process' }, { id: 12003, x: 22, y: 68, label: 'Urgence artificielle' }], quizQuestions: [{ id: 1201, prompt: 'Quelle règle anti-fraude ?' }, { id: 1202, prompt: 'Pourquoi double validation ?' }, { id: 1203, prompt: 'Quel canal de confirmation ?' }] },
]
